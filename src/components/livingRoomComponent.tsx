...
export const Vocabulary = ({ goBack, backgroundColor, title }) => {
  ...
  const data = [
    {
      name: require("../assets/livingRoomImages/sofa.jpeg"),
      title: "SOFA",
    },
    {
      name: require("../assets/livingRoomImages/kissen.jpeg"),
      title: "KISSEN",
    },
    {
      name: require("../assets/livingRoomImages/wohnzimmertisch.jpeg"),
      title: "WOHNZIMMERTISCH",
    },
    {
      name: require("../assets/livingRoomImages/teppich.jpeg"),
      title: "TEPPICH",
    },
    {
      name: require("../assets/livingRoomImages/pflanze.jpeg"),
      title: "PFLANZE",
    },
    {
      name: require("../assets/livingRoomImages/sessel.jpeg"),
      title: "SESSEL",
    },
    {
      name: require("../assets/livingRoomImages/fenster.jpeg"),
      title: "FENSTER",
    },
    {
      name: require("../assets/livingRoomImages/vorhange.jpeg"),
      title: "WORHÄNGE",
    },
    {
      name: require("../assets/livingRoomImages/bild.jpeg"),
      title: "BILD",
    },
    {
      name: require("../assets/livingRoomImages/kamin.png"),
      title: "KAMIN",
    },
    {
      name: require("../assets/livingRoomImages/tur.jpeg"),
      title: "TÜR",
    },
    {
      name: require("../assets/livingRoomImages/treppe.png"),
      title: "TREPPE",
    },
  ];
  ...
  return (
    <View style={{ flex: 1, marginBottom: hp(16) }}>
      ...
      />
      {completedVocabularies?.item === 12 &&
      completedVocabularies?.screenName === "living" ? (
        <View>
        ...
        <View>
          <View style={styles.length}>
            <Text style={styles.text}>{itemsPressed}/12</Text>
            <Bar
              progress={progress}
              width={wp(75)}
              height={hp(5)}
...
export const Reading = ({ goBack, backgroundColor, title }) => {
  ...
  const options = [
    {
      image: require("../assets/livingRoomImages/sofa.jpeg"),
      title: "SOFA",
    },
    {
      image: require("../assets/livingRoomImages/kissen.jpeg"),
      title: "KISSEN",
    },
    {
      image: require("../assets/livingRoomImages/wohnzimmertisch.jpeg"),
      title: "WOHNZIMMERTISCH",
    },
    {
      image: require("../assets/livingRoomImages/teppich.jpeg"),
      title: "TEPPICH",
    },
    {
      image: require("../assets/livingRoomImages/pflanze.jpeg"),
      title: "PFLANZE",
    },
    {
      image: require("../assets/livingRoomImages/sessel.jpeg"),
      title: "SESSEL",
    },
    {
      image: require("../assets/livingRoomImages/fenster.jpeg"),
      title: "FENSTER",
    },
    {
      image: require("../assets/livingRoomImages/vorhange.jpeg"),
      title: "WORHÄNGE",
    },
    {
      image: require("../assets/livingRoomImages/bild.jpeg"),
      title: "BILD",
    },
    {
      image: require("../assets/livingRoomImages/kamin.png"),
      title: "KAMIN",
    },
    {
      image: require("../assets/livingRoomImages/tur.jpeg"),
      title: "TÜR",
    },
    {
      image: require("../assets/livingRoomImages/treppe.png"),
      title: "TREPPE",
    },
  ];
