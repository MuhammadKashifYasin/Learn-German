...
export const Vocabulary = ({ goBack, backgroundColor, title }) => {
  ...
  const data = [
    {
      name: require("../assets/foodImages/sandwich.jpg"),
      title: "DAS\nSANDWICH",
    },
    {
      name: require("../assets/foodImages/pizza.jpg"),
      title: "DIE\nPIZZA",
    },
    {
      name: require("../assets/foodImages/wurst.jpg"),
      title: "DIE\nWURST",
    },
    {
      name: require("../assets/foodImages/burger.jpg"),
      title: "DER\nBURGER",
    },
    {
      name: require("../assets/foodImages/pommes-frites.jpg"),
      title: "DIE\nPOMMES FRITES",
    },
    {
      name: require("../assets/foodImages/schinken.webp"),
      title: "DER\nSCHINKEN",
    },
    {
      name: require("../assets/foodImages/nudeln.webp"),
      title: "DIE\nNUDELN",
    },
    {
      name: require("../assets/foodImages/reis.jpg"),
      title: "DER\nREIS",
    },
    {
      name: require("../assets/foodImages/brot.webp"),
      title: "DAS\nBROT",
    },
    {
      name: require("../assets/foodImages/kase.jpg"),
      title: "DER\nKÄSE",
    },
    {
      name: require("../assets/foodImages/EI.jpg"),
      title: "DAS\nEI",
    },
    {
      name: require("../assets/foodImages/meet.jpg"),
      title: "DAS\nFLEISCH",
    },
    {
      name: require("../assets/foodImages/fish.webp"),
      title: "DER\nFISCH",
    },
    {
      name: require("../assets/foodImages/hahnchen.webp"),
      title: "DAS\nHÄHNCHEN",
    },
    {
      name: require("../assets/foodImages/seafood.jpg"),
      title: "DIE\nMEERESFRÜCHTE",
    },
    {
      name: require("../assets/foodImages/sushi.jpg"),
      title: "DAS\nSUSHI",
    },
    {
      name: require("../assets/foodImages/salat.jpg"),
      title: "DER\nSALAT",
    },
    {
      name: require("../assets/foodImages/suppe.webp"),
      title: "DIE\nSUPPE",
    },
    {
      name: require("../assets/foodImages/cornflakes.webp"),
      title: "DIE\nKORNFLAKES",
    },
    {
      name: require("../assets/foodImages/oil.webp"),
      title: "DAS\nÖL",
    },
    {
      name: require("../assets/foodImages/viniger.jpg"),
      title: "DER\nESSIG",
    },
    {
      name: require("../assets/foodImages/butter.jpg"),
      title: "DIE\nBUTTER",
    },
    {
      name: require("../assets/foodImages/jam.jpg"),
      title: "DIE\nMARMELADE",
    },
    {
      name: require("../assets/foodImages/myonnaise.jpg"),
      title: "DIE\nMAYONNAISE",
    },
    {
      name: require("../assets/foodImages/zucker.jpg"),
      title: "DER\nZUCKER",
    },
    {
      name: require("../assets/foodImages/salz.jpg"),
      title: "DAS\nSALZ",
    },
    {
      name: require("../assets/foodImages/spiced.jpg"),
      title: "DIE\nGEWÜRZE",
    },
  ];
  ...
  return (
    <View style={{ flex: 1, marginBottom: hp(16) }}>
      ...
      />
      {completedVocabularies?.item === 27 &&
      completedVocabularies?.screenName === "food" ? (
        <View>
          <View style={styles.length}>
            <Text style={styles.text}>27/27</Text>
            <Bar
              progress={1}
              width={wp(75)}
              height={hp(5)}
        ...
        <View>
          <View style={styles.length}>
            <Text style={styles.text}>{itemsPressed}/27</Text>
            <Bar
              progress={progress}
              width={wp(75)}
              height={hp(5)}
...
export const Reading = ({ goBack, backgroundColor, title }) => {
  ...
  const options = [
    {
      image: require("../assets/foodImages/sandwich.jpg"),
      title: "DAS\nSANDWICH",
    },
    {
      image: require("../assets/foodImages/pizza.jpg"),
      title: "DIE\nPIZZA",
    },
    {
      image: require("../assets/foodImages/wurst.jpg"),
      title: "DIE\nWURST",
    },
    {
      image: require("../assets/foodImages/burger.jpg"),
      title: "DER\nBURGER",
    },
    {
      image: require("../assets/foodImages/pommes-frites.jpg"),
      title: "DIE\nPOMMES FRITES",
    },
    {
      image: require("../assets/foodImages/schinken.webp"),
      title: "DER\nSCHINKEN",
    },
    {
      image: require("../assets/foodImages/nudeln.webp"),
      title: "DIE\nNUDELN",
    },
    {
      image: require("../assets/foodImages/reis.jpg"),
      title: "DER\nREIS",
    },
    {
      image: require("../assets/foodImages/brot.webp"),
      title: "DAS\nBROT",
    },
    {
      image: require("../assets/foodImages/kase.jpg"),
      title: "DER\nKÄSE",
    },
    {
      image: require("../assets/foodImages/EI.jpg"),
      title: "DAS\nEI",
    },
    {
      image: require("../assets/foodImages/meet.jpg"),
      title: "DAS\nFLEISCH",
    },
    {
      image: require("../assets/foodImages/fish.webp"),
      title: "DER\nFISCH",
    },
    {
      image: require("../assets/foodImages/hahnchen.webp"),
      title: "DAS\nHÄHNCHEN",
    },
    {
      image: require("../assets/foodImages/seafood.jpg"),
      title: "DIE\nMEERESFRÜCHTE",
    },
    {
      image: require("../assets/foodImages/sushi.jpg"),
      title: "DAS\nSUSHI",
    },
    {
      image: require("../assets/foodImages/salat.jpg"),
      title: "DER\nSALAT",
    },
    {
      image: require("../assets/foodImages/suppe.webp"),
      title: "DIE\nSUPPE",
    },
    {
      image: require("../assets/foodImages/cornflakes.webp"),
      title: "DIE\nKORNFLAKES",
    },
    {
      image: require("../assets/foodImages/oil.webp"),
      title: "DAS\nÖL",
    },
    {
      image: require("../assets/foodImages/viniger.jpg"),
      title: "DER\nESSIG",
    },
    {
      image: require("../assets/foodImages/butter.jpg"),
      title: "DIE\nBUTTER",
    },
    {
      image: require("../assets/foodImages/jam.jpg"),
      title: "DIE\nMARMELADE",
    },
    {
      image: require("../assets/foodImages/myonnaise.jpg"),
      title: "DIE\nMAYONNAISE",
    },
    {
      image: require("../assets/foodImages/zucker.jpg"),
      title: "DER\nZUCKER",
    },
    {
      image: require("../assets/foodImages/salz.jpg"),
      title: "DAS\nSALZ",
    },
    {
      image: require("../assets/foodImages/spiced.jpg"),
      title: "DIE\nGEWÜRZE",
    },
  ];
