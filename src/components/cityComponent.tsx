...
export const Vocabulary = ({ goBack, backgroundColor, title }) => {
  ...
  const data = [
    {
      name: require("../assets/cityImages/strasse.jpeg"),
      title: "STRASSE",
    },
    {
      name: require("../assets/cityImages/zebrastreifen.png"),
      title: "ZEBRASTREIFEN",
    },
    {
      name: require("../assets/cityImages/ampel.png"),
      title: "AMPEL",
    },
    {
      name: require("../assets/cityImages/strassenlicht.jpeg"),
      title: "STRASSENLICHT",
    },
    {
      name: require("../assets/cityImages/bank.jpeg"),
      title: "BANK",
    },
    {
      name: require("../assets/cityImages/schild.jpeg"),
      title: "SCHILD",
    },
    {
      name: require("../assets/cityImages/briefkasten.jpeg"),
      title: "BRIEFKASTEN",
    },
    {
      name: require("../assets/cityImages/telefonzelle.jpeg"),
      title: "TELEFONZELLE",
    },
    {
      name: require("../assets/cityImages/bushaltestelle.jpeg"),
      title: "BUSHALTESTELLE",
    },
    {
      name: require("../assets/cityImages/gebaude.jpeg"),
      title: "GEBÄUDE",
    },
    {
      name: require("../assets/cityImages/park.jpeg"),
      title: "PARK",
    },
    {
      name: require("../assets/cityImages/haus.png"),
      title: "HAUS",
    },
  ];
  ...
  return (
    <View style={{ flex: 1, marginBottom: hp(16) }}>
      ...
      completedVocabularies?.screenName === "city" ? (
        <View>
...
export const Reading = ({ goBack, backgroundColor, title }) => {
  ...
  const options = [
    {
      image: require("../assets/cityImages/strasse.jpeg"),
      title: "STRASSE",
    },
    {
      image: require("../assets/cityImages/zebrastreifen.png"),
      title: "ZEBRASTREIFEN",
    },
    {
      image: require("../assets/cityImages/ampel.png"),
      title: "AMPEL",
    },
    {
      image: require("../assets/cityImages/strassenlicht.jpeg"),
      title: "STRASSENLICHT",
    },
    {
      image: require("../assets/cityImages/bank.jpeg"),
      title: "BANK",
    },
    {
      image: require("../assets/cityImages/schild.jpeg"),
      title: "SCHILD",
    },
    {
      image: require("../assets/cityImages/briefkasten.jpeg"),
      title: "BRIEFKASTEN",
    },
    {
      image: require("../assets/cityImages/telefonzelle.jpeg"),
      title: "TELEFONZELLE",
    },
    {
      image: require("../assets/cityImages/bushaltestelle.jpeg"),
      title: "BUSHALTESTELLE",
    },
    {
      image: require("../assets/cityImages/gebaude.jpeg"),
      title: "GEBÄUDE",
    },
    {
      image: require("../assets/cityImages/park.jpeg"),
      title: "PARK",
    },
    {
      image: require("../assets/cityImages/haus.png"),
      title: "HAUS",
    },
  ];
