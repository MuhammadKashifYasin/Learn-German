...
export const Vocabulary = ({ goBack, backgroundColor, title }) => {
  ...
  const data = [
    {
      name: require("../assets/bathImages/toilette.jpeg"),
      title: "TOILETTE",
    },
    {
      name: require("../assets/bathImages/papier.jpeg"),
      title: "PAPIER",
    },
    {
      name: require("../assets/bathImages/waschbacken.jpeg"),
      title: "WASCHBACKEN",
    },
    {
      name: require("../assets/bathImages/wasserhahn.jpeg"),
      title: "WASSERHAHN",
    },
    {
      name: require("../assets/bathImages/seife.jpeg"),
      title: "SEIFE",
    },
    {
      name: require("../assets/bathImages/handtuch.jpeg"),
      title: "HANDTUCH",
    },
    {
      name: require("../assets/bathImages/spiegel.jpeg"),
      title: "SPEIGEL",
    },
    {
      name: require("../assets/bathImages/dusche.png"),
      title: "DUSCHE",
    },
    {
      name: require("../assets/bathImages/badewanne.jpeg"),
      title: "BADEWANNE",
    },
    {
      name: require("../assets/bathImages/zahnburste.jpeg"),
      title: "ZAHNBÜRSTE",
    },
    {
      name: require("../assets/bathImages/zahnpasta.jpeg"),
      title: "ZAHNPASTA",
    },
    {
      name: require("../assets/bathImages/schwamm.jpeg"),
      title: "SCHWAMM",
    },
  ];
  ...
  return (
    <View style={{ flex: 1, marginBottom: hp(16) }}>
      ...
      completedVocabularies?.screenName === "bath" ? (
        <View>
...
export const Reading = ({ goBack, backgroundColor, title }) => {
  ...
  const options = [
    {
      image: require("../assets/bathImages/toilette.jpeg"),
      title: "TOILETTE",
    },
    {
      image: require("../assets/bathImages/papier.jpeg"),
      title: "PAPIER",
    },
    {
      image: require("../assets/bathImages/waschbacken.jpeg"),
      title: "WASCHBACKEN",
    },
    {
      image: require("../assets/bathImages/wasserhahn.jpeg"),
      title: "WASSERHAHN",
    },
    {
      image: require("../assets/bathImages/seife.jpeg"),
      title: "SEIFE",
    },
    {
      image: require("../assets/bathImages/handtuch.jpeg"),
      title: "HANDTUCH",
    },
    {
      image: require("../assets/bathImages/spiegel.jpeg"),
      title: "SPEIGEL",
    },
    {
      image: require("../assets/bathImages/dusche.png"),
      title: "DUSCHE",
    },
    {
      image: require("../assets/bathImages/badewanne.jpeg"),
      title: "BADEWANNE",
    },
    {
      image: require("../assets/bathImages/zahnburste.jpeg"),
      title: "ZAHNBÜRSTE",
    },
    {
      image: require("../assets/bathImages/zahnpasta.jpeg"),
      title: "ZAHNPASTA",
    },
    {
      image: require("../assets/bathImages/schwamm.jpeg"),
      title: "SCHWAMM",
    },
  ];
