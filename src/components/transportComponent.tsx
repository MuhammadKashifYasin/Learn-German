...
export const Vocabulary = ({ goBack, backgroundColor, title }) => {
  ...
  const data = [
    {
      name: require("../assets/transport/bicycle.jpg"),
      title: "DAS\nFAHRRAD",
    },
    {
      name: require("../assets/transport/train.jpg"),
      title: "DER\nZUG",
    },
    {
      name: require("../assets/transport/car.jpg"),
      title: "DAS\nAUTO",
    },
    {
      name: require("../assets/transport/ship.jpg"),
      title: "DAS\nFLUGZEUG",
    },
    {
      name: require("../assets/transport/Flugzeug.jpg"),
      title: "DAS\nMOTORRAD",
    },
    {
      name: require("../assets/transport/motorrad.jpg"),
      title: "DER\nLKW",
    },
    {
      name: require("../assets/transport/truck.webp"),
      title: "DER\nBUS",
    },
    {
      name: require("../assets/transport/bus.jpg"),
      title: "DER\nHUBSCHRAUBRER",
    },
    {
      name: require("../assets/transport/helicopter.jpg"),
      title: "DIE\nU-BAHN",
    },
    {
      name: require("../assets/transport/boat.jpg"),
      title: "DAS\nBOOT",
    },
    {
      name: require("../assets/transport/lieferwagen.png"),
      title: "DER\nLIEFERWAGEN",
    },
    {
      name: require("../assets/transport/wohnmobil.jpg"),
      title: "DAS\nWOHNMOBIL",
    },
    {
      name: require("../assets/transport/quad.jpg"),
      title: "DAS\nQUAD",
    },
    {
      name: require("../assets/transport/krankenwagen.jpg"),
      title: "DER\nKRANKENWAGEN",
    },
    {
      name: require("../assets/transport/u-boot.jpg"),
      title: "DAS\nU-BOOT",
    },
    {
      name: require("../assets/transport/fireTruck.webp"),
      title: "DAS\nFEUERWEHRFAHRZEUG",
    },
    {
      name: require("../assets/transport/hot-air-baloon.jpg"),
      title: "DER\nHEISSLUFTBALLON",
    },
  ];
  ...
  return (
    <View style={{ flex: 1, marginBottom: hp(16) }}>
      ...
      />
      {completedVocabularies?.item === 17 &&
      completedVocabularies?.screenName === "transport" ? (
        <View>
          <View style={styles.length}>
            <Text style={styles.text}>17/17</Text>
            <Bar
              progress={1}
              width={wp(75)}
              height={hp(5)}
        ...
        <View>
          <View style={styles.length}>
            <Text style={styles.text}>{itemsPressed}/17</Text>
            <Bar
              progress={progress}
              width={wp(75)}
              height={hp(5)}
...
export const Reading = ({ goBack, backgroundColor, title }) => {
  ...
  const options = [
    {
      image: require("../assets/transport/bicycle.jpg"),
      title: "DAS\nFAHRRAD",
    },
    {
      image: require("../assets/transport/train.jpg"),
      title: "DER\nZUG",
    },
    {
      image: require("../assets/transport/car.jpg"),
      title: "DAS\nAUTO",
    },
    {
      image: require("../assets/transport/ship.jpg"),
      title: "DAS\nFLUGZEUG",
    },
    {
      image: require("../assets/transport/Flugzeug.jpg"),
      title: "DAS\nMOTORRAD",
    },
    {
      image: require("../assets/transport/motorrad.jpg"),
      title: "DER\nLKW",
    },
    {
      image: require("../assets/transport/truck.webp"),
      title: "DER\nBUS",
    },
    {
      image: require("../assets/transport/bus.jpg"),
      title: "DER\nHUBSCHRAUBRER",
    },
    {
      image: require("../assets/transport/helicopter.jpg"),
      title: "DIE\nU-BAHN",
    },
    {
      image: require("../assets/transport/boat.jpg"),
      title: "DAS\nBOOT",
    },
    {
      image: require("../assets/transport/lieferwagen.png"),
      title: "DER\nLIEFERWAGEN",
    },
    {
      image: require("../assets/transport/wohnmobil.jpg"),
      title: "DAS\nWOHNMOBIL",
    },
    {
      image: require("../assets/transport/quad.jpg"),
      title: "DAS\nQUAD",
    },
    {
      image: require("../assets/transport/krankenwagen.jpg"),
      title: "DER\nKRANKENWAGEN",
    },
    {
      image: require("../assets/transport/u-boot.jpg"),
      title: "DAS\nU-BOOT",
    },
    {
      image: require("../assets/transport/fireTruck.webp"),
      title: "DAS\nFEUERWEHRFAHRZEUG",
    },
    {
      image: require("../assets/transport/hot-air-baloon.jpg"),
      title: "DER\nHEISSLUFTBALLON",
    },
  ];
