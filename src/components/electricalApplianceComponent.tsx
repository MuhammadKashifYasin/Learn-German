...
export const Vocabulary = ({ goBack, backgroundColor, title }) => {
  ...
  const data = [
    {
      name: require("../assets/electricImages/staubsauger.jpeg"),
      title: "STAUBSAUGER",
    },
    {
      name: require("../assets/electricImages/kaffeemaschine.jpeg"),
      title: "KAFFEEMASCHINE",
    },
    {
      name: require("../assets/electricImages/kuhlschrank.jpeg"),
      title: "KÜHLSCHRANK",
    },
    {
      name: require("../assets/electricImages/fohn.jpeg"),
      title: "FÖHN",
    },
    {
      name: require("../assets/electricImages/heizung.jpeg"),
      title: "HEIZUNG",
    },
    {
      name: require("../assets/electricImages/bugeleisen.jpeg"),
      title: "BÜGELEISEN",
    },
    {
      name: require("../assets/electricImages/mikrowelle.jpeg"),
      title: "MIKROWELLE",
    },
    {
      name: require("../assets/electricImages/mixer.jpeg"),
      title: "MIXER",
    },
    {
      name: require("../assets/electricImages/ofen.jpeg"),
      title: "OFEN",
    },
    {
      name: require("../assets/electricImages/fernseher.jpeg"),
      title: "FERNSEHER",
    },
    {
      name: require("../assets/electricImages/toaster.jpeg"),
      title: "TOASTER",
    },
    {
      name: require("../assets/electricImages/waschmaschine.jpeg"),
      title: "WASCHMASCHINE",
    },
    {
      name: require("../assets/electricImages/klimaanlage.png"),
      title: "KLIMAANLAGE",
    },
    {
      name: require("../assets/electricImages/geschirrspuler.jpeg"),
      title: "GESCHIRRSPULER",
    },
    {
      name: require("../assets/electricImages/herd.jpeg"),
      title: "HERD",
    },
  ];
  ...
  return (
    <View style={{ flex: 1, marginBottom: hp(16) }}>
      ...
      completedVocabularies?.screenName === "halloween" ? (
        ...
        <View>
          <View style={styles.length}>
            <Text style={styles.text}>{itemsPressed}/15</Text>
            <Bar
              progress={progress}
              width={wp(75)}
              height={hp(5)}
...
export const Reading = ({ goBack, backgroundColor, title }) => {
  ...
  const options = [
    {
      image: require("../assets/electricImages/staubsauger.jpeg"),
      title: "STAUBSAUGER",
    },
    {
      image: require("../assets/electricImages/kaffeemaschine.jpeg"),
      title: "KAFFEEMASCHINE",
    },
    {
      image: require("../assets/electricImages/kuhlschrank.jpeg"),
      title: "KÜHLSCHRANK",
    },
    {
      image: require("../assets/electricImages/fohn.jpeg"),
      title: "FÖHN",
    },
    {
      image: require("../assets/electricImages/heizung.jpeg"),
      title: "HEIZUNG",
    },
    {
      image: require("../assets/electricImages/bugeleisen.jpeg"),
      title: "BÜGELEISEN",
    },
    {
      image: require("../assets/electricImages/mikrowelle.jpeg"),
      title: "MIKROWELLE",
    },
    {
      image: require("../assets/electricImages/mixer.jpeg"),
      title: "MIXER",
    },
    {
      image: require("../assets/electricImages/ofen.jpeg"),
      title: "OFEN",
    },
    {
      image: require("../assets/electricImages/fernseher.jpeg"),
      title: "FERNSEHER",
    },
    {
      image: require("../assets/electricImages/toaster.jpeg"),
      title: "TOASTER",
    },
    {
      image: require("../assets/electricImages/waschmaschine.jpeg"),
      title: "WASCHMASCHINE",
    },
    {
      image: require("../assets/electricImages/klimaanlage.png"),
      title: "KLIMAANLAGE",
    },
    {
      image: require("../assets/electricImages/geschirrspuler.jpeg"),
      title: "GESCHIRRSPULER",
    },
    {
      image: require("../assets/electricImages/herd.jpeg"),
      title: "HERD",
    },
  ];
