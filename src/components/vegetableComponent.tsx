...
export const Vocabulary = ({ goBack, backgroundColor, title }) => {
  ...
  const data = [
    {
      name: require("../assets/Vegetables/tomato.jpg"),
      title: "DIE\nTOMATE",
    },
    {
      name: require("../assets/Vegetables/potato.webp"),
      title: "DIE\nKARTOFFEL",
    },
    {
      name: require("../assets/Vegetables/onion.webp"),
      title: "DIE\nZWIEBEL",
    },
    {
      name: require("../assets/Vegetables/carrot.webp"),
      title: "DIE\nKAROTTE",
    },
    {
      name: require("../assets/Vegetables/kopfsalat.jpeg"),
      title: "DER\nKOPFSALAT",
    },
    {
      name: require("../assets/Vegetables/Mais.webp"),
      title: "DER\nMAIS",
    },
    {
      name: require("../assets/Vegetables/paprika.jpg"),
      title: "DIE\nPAPRIKA",
    },
    {
      name: require("../assets/Vegetables/brokkoli.webp"),
      title: "DER\nBROKKOLI",
    },
    {
      name: require("../assets/Vegetables/gurke.jpg"),
      title: "DIE\nGURKE",
    },
    {
      name: require("../assets/Vegetables/pilz.jpg"),
      title: "DER\nPILZ",
    },
    {
      name: require("../assets/Vegetables/knoblauch.jpg"),
      title: "DER\nKNOBLAUCH",
    },
    {
      name: require("../assets/Vegetables/kurbis.webp"),
      title: "DER\nKÜRBIS",
    },
    {
      name: require("../assets/Vegetables/aubergine.jpg"),
      title: "DIE\nAUBERGINE",
    },
    {
      name: require("../assets/Vegetables/blumenkohl.jpg"),
      title: "DER\nBLUMENKOHL",
    },
    {
      name: require("../assets/Vegetables/bohnen.jpg"),
      title: "DIE\nBOHNEN",
    },
    {
      name: require("../assets/Vegetables/rettich.webp"),
      title: "DER\nRETTICH",
    },
    {
      name: require("../assets/Vegetables/petersilie.webp"),
      title: "DIE\nPETERSILIE",
    },
    {
      name: require("../assets/Vegetables/chili.webp"),
      title: "DAS\nCHILI",
    },
  ];
  ...
  return (
    <View style={{ flex: 1, marginBottom: hp(16) }}>
      ...
      completedVocabularies?.screenName === "vegetable" ? (
        <View>
...
export const Reading = ({ goBack, backgroundColor, title }) => {
  ...
  const options = [
    ...
    {
      image: require("../assets/Vegetables/potato.webp"),
      title: "DIE\nKARTOFFEL",
    },
    {
      image: require("../assets/Vegetables/onion.webp"),
      title: "DIE\nZWIEBEL",
    },
    {
      image: require("../assets/Vegetables/carrot.webp"),
      title: "DIE\nKAROTTE",
    },
    {
      image: require("../assets/Vegetables/kopfsalat.jpeg"),
      title: "DER\nKOPFSALAT",
    },
    {
      image: require("../assets/Vegetables/Mais.webp"),
      title: "DER\nMAIS",
    },
    {
      image: require("../assets/Vegetables/paprika.jpg"),
      title: "DIE\nPAPRIKA",
    },
    {
      image: require("../assets/Vegetables/brokkoli.webp"),
      title: "DER\nBROKKOLI",
    },
    {
      image: require("../assets/Vegetables/gurke.jpg"),
      title: "DIE\nGURKE",
    },
    {
      image: require("../assets/Vegetables/pilz.jpg"),
      title: "DER\nPILZ",
    },
    {
      image: require("../assets/Vegetables/knoblauch.jpg"),
      title: "DER\nKNOBLAUCH",
    },
    {
      image: require("../assets/Vegetables/kurbis.webp"),
      title: "DER\nKÜRBIS",
    },
    {
      image: require("../assets/Vegetables/aubergine.jpg"),
      title: "DIE\nAUBERGINE",
    },
    {
      image: require("../assets/Vegetables/blumenkohl.jpg"),
      title: "DER\nBLUMENKOHL",
    },
    {
      image: require("../assets/Vegetables/bohnen.jpg"),
      title: "DIE\nBOHNEN",
    },
    {
      image: require("../assets/Vegetables/rettich.webp"),
      title: "DER\nRETTICH",
    },
    {
      image: require("../assets/Vegetables/petersilie.webp"),
      title: "DIE\nPETERSILIE",
    },
    {
      image: require("../assets/Vegetables/chili.webp"),
      title: "DAS\nCHILI",
    },
  ];
