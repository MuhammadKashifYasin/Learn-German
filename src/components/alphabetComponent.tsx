...
export const Vocabulary = ({goBack, backgroundColor}) => {
  ...
  const data = [
    ...
    {
      name: require('../assets/AtoZImages/dottedA.png'),
      title: 'Ä',
    },
    {
      name: require('../assets/AtoZImages/Oo.png'),
      title: 'Ö',
    },
    {
      name: require('../assets/AtoZImages/dottedU.png'),
      title: 'Ü',
    },
    {
      name: require('../assets/AtoZImages/beta.png'),
      title: 'SCHARFES S',
    },
  ];
  ...
  return (
    <View style={{flex: 1, marginBottom: hp(7)}}>
      ...
      completedVocabularies?.screenName === 'alphabet' ? (
              ...
              {data.map((item, index) => (
                <TouchableOpacity
                  ...
                  <View style={{marginVertical: 10}}>
                    <Text style={{fontSize: 18, textAlign: 'center'}}>DAS</Text>
                    <Text
                      style={{
                        fontSize: 15,
        ...
        <View>
          <View style={styles.length}>
            <Text style={styles.text}>{itemsPressed}/30</Text>
            <Bar
              progress={progress}
              width={wp(75)}
              height={hp(5)}
...
export const Listening = ({goBack, backgroundColor}) => {
  ...
  const imagesWithTitles = [
    ...
    {
      image: require('../assets/AtoZImages/dottedA.png'),
      title: 'Ä',
    },
    {
      image: require('../assets/AtoZImages/Oo.png'),
      title: 'Ö',
    },
    {
      image: require('../assets/AtoZImages/dottedU.png'),
      title: 'Ü',
    },
    {
      image: require('../assets/AtoZImages/beta.png'),
      title: 'SCHARFES S',
    },
  ];
    ...
    <View>
      ...
      <View style={styles.mcqs}>
        {lowerState?.map((option, index) => {
          const filteredImages = ImageArr.filter(item => item.title === option);
    ...
    <View>
      ...
      <View
        ...
        <View style={styles.option}>
          {spokenWord && (
            <Image source={spokenWord?.image} style={{width: 50, height: 50}} />
          )}
          {/* <Text
            style={{
              color: "#000",
      ...
      <View
        style={[styles.textBox, {borderColor: selecteWord ? 'green' : 'gray'}]}>
