...
export const Vocabulary = ({ goBack, backgroundColor, title }) => {
  ...
  const data = [
    {
      name: require("../assets/fruites/banane.jpg"),
      title: "DIE\nBANANE",
    },
    {
      name: require("../assets/fruites/apple.jpg"),
      title: "DER\nAPFEL",
    },
    {
      name: require("../assets/fruites/lemon.webp"),
      title: "DIE\nZITRONE",
    },
    {
      name: require("../assets/fruites/kokosnuss.jpg"),
      title: "DIE\nKOKOSNUSS",
    },
    {
      name: require("../assets/fruites/trauben.webp"),
      title: "DIE\nTRAUBEN",
    },
    {
      name: require("../assets/fruites/kirschen.webp"),
      title: "DIE\nKIRSCHEN",
    },
    {
      name: require("../assets/fruites/orange.jpg"),
      title: "DIE\nORANGE",
    },
    {
      name: require("../assets/fruites/birne.webp"),
      title: "DIE\nBIRNE",
    },
    {
      name: require("../assets/fruites/erdbeere.jpg"),
      title: "DIE\nERDBEERE",
    },
    {
      name: require("../assets/fruites/ananas.jpg"),
      title: "DIE\nANANAS",
    },
    {
      name: require("../assets/fruites/watermelon.jpg"),
      title: "DIE\nWASSERMELONE",
    },
    {
      name: require("../assets/fruites/pfirsich.jpg"),
      title: "DER\nPFIRSICH",
    },
    {
      name: require("../assets/fruites/limette.jpg"),
      title: "DIE\nLIMETTE",
    },
    {
      name: require("../assets/fruites/kiwifruit.jpg"),
      title: "DIE\nKIWI",
    },
    {
      name: require("../assets/fruites/avocado.jpg"),
      title: "DIE\nAVOCADO",
    },
    {
      name: require("../assets/fruites/melone.jpg"),
      title: "DIE\nMELONE",
    },
    {
      name: require("../assets/fruites/blackberry.jpg"),
      title: "DIE\nBROMBEERE",
    },
    {
      name: require("../assets/fruites/feige.jpg"),
      title: "DIE\nFEIGE",
    },
    {
      name: require("../assets/fruites/walnuss.webp"),
      title: "DIE\nWALNUSS",
    },
    {
      name: require("../assets/fruites/haselnuss.webp"),
      title: "DIE\nHASENNUSS",
    },
    {
      name: require("../assets/fruites/almond.jpg"),
      title: "DIE\nMANDEL",
    },
  ];
  ...
  return (
    <View style={{ flex: 1, marginBottom: hp(16) }}>
      ...
      completedVocabularies?.screenName === "fruit" ? (
        <View>
...
export const Reading = ({ goBack, backgroundColor, title }) => {
  ...
  const options = [
    {
      image: require("../assets/fruites/banane.jpg"),
      title: "DIE\nBANANE",
    },
    {
      image: require("../assets/fruites/apple.jpg"),
      title: "DER\nAPFEL",
    },
    {
      image: require("../assets/fruites/lemon.webp"),
      title: "DIE\nZITRONE",
    },
    {
      image: require("../assets/fruites/kokosnuss.jpg"),
      title: "DIE\nKOKOSNUSS",
    },
    {
      image: require("../assets/fruites/trauben.webp"),
      title: "DIE\nTRAUBEN",
    },
    {
      image: require("../assets/fruites/kirschen.webp"),
      title: "DIE\nKIRSCHEN",
    },
    {
      image: require("../assets/fruites/orange.jpg"),
      title: "DIE\nORANGE",
    },
    {
      image: require("../assets/fruites/birne.webp"),
      title: "DIE\nBIRNE",
    },
    {
      image: require("../assets/fruites/erdbeere.jpg"),
      title: "DIE\nERDBEERE",
    },
    {
      image: require("../assets/fruites/ananas.jpg"),
      title: "DIE\nANANAS",
    },
    {
      image: require("../assets/fruites/watermelon.jpg"),
      title: "DIE\nWASSERMELONE",
    },
    {
      image: require("../assets/fruites/pfirsich.jpg"),
      title: "DER\nPFIRSICH",
    },
    {
      image: require("../assets/fruites/limette.jpg"),
      title: "DIE\nLIMETTE",
    },
    {
      image: require("../assets/fruites/kiwifruit.jpg"),
      title: "DIE\nKIWI",
    },
    {
      image: require("../assets/fruites/avocado.jpg"),
      title: "DIE\nAVOCADO",
    },
    {
      image: require("../assets/fruites/melone.jpg"),
      title: "DIE\nMELONE",
    },
    {
      image: require("../assets/fruites/blackberry.jpg"),
      title: "DIE\nBROMBEERE",
    },
    {
      image: require("../assets/fruites/feige.jpg"),
      title: "DIE\nFEIGE",
    },
    {
      image: require("../assets/fruites/walnuss.webp"),
      title: "DIE\nWALNUSS",
    },
    {
      image: require("../assets/fruites/haselnuss.webp"),
      title: "DIE\nHASENNUSS",
    },
    {
      image: require("../assets/fruites/almond.jpg"),
      title: "DIE\nMANDEL",
    },
  ];
