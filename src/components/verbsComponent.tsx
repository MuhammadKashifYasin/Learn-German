...
export const Vocabulary = ({ goBack, backgroundColor, title }) => {
  ...
  const data = [
    {
      name: require("../assets/verbs/kochen.jpg"),
      title: "KOCHEN",
    },
    {
      name: require("../assets/verbs/essen.jpeg"),
      title: "ESSEN",
    },
    {
      name: require("../assets/verbs/springen.png"),
      title: "SPRINGEN",
    },
    {
      name: require("../assets/verbs/rennen.jpg"),
      title: "RENNEN",
    },
    {
      name: require("../assets/verbs/singen.jpg"),
      title: "SINGEN",
    },
    {
      name: require("../assets/verbs/schlafen.jpeg"),
      title: "SCHLAFEN",
    },
    {
      name: require("../assets/verbs/schwimmen.jpg"),
      title: "SCHWIMMEN",
    },
    {
      name: require("../assets/verbs/gehen.png"),
      title: "GEHEN",
    },
    {
      name: require("../assets/verbs/schreiben.jpg"),
      title: "SCHREIBEN",
    },
    {
      name: require("../assets/verbs/reinigen.png"),
      title: "REINIGEN",
    },
    {
      name: require("../assets/verbs/malen.jpeg"),
      title: "MALEN",
    },
    {
      name: require("../assets/verbs/waschen.jpeg"),
      title: "WASCHEN",
    },
    {
      name: require("../assets/verbs/lesen.png"),
      title: "LESEN",
    },
    {
      name: require("../assets/verbs/anrufen.jpeg"),
      title: "ANRUFEN",
    },
    {
      name: require("../assets/verbs/arbeiten.jpg"),
      title: "ARBEITEN",
    },
    {
      name: require("../assets/verbs/sprechen.png"),
      title: "SPRECHEN",
    },
    {
      name: require("../assets/verbs/denken.jpg"),
      title: "DENKEN",
    },
    {
      name: require("../assets/verbs/schneiden.jpg"),
      title: "SCHNEIDEN",
    },
    {
      name: require("../assets/verbs/tanzen.webp"),
      title: "TANZEN",
    },
    {
  ...
  return (
    <View style={{ flex: 1, marginBottom: hp(16) }}>
      ...
      />
      {completedVocabularies?.item === 20 &&
      completedVocabularies?.screenName === "verbs" ? (
        <View>
        ...
        <View>
          <View style={styles.length}>
            <Text style={styles.text}>{itemsPressed}/20</Text>
            <Bar
              progress={progress}
              width={wp(75)}
              height={hp(5)}
...
export const Reading = ({ goBack, backgroundColor, title }) => {
  ...
  const options = [
    {
      image: require("../assets/verbs/kochen.jpg"),
      title: "KOCHEN",
    },
    {
      image: require("../assets/verbs/essen.jpeg"),
      title: "ESSEN",
    },
    {
      image: require("../assets/verbs/springen.png"),
      title: "SPRINGEN",
    },
    {
      image: require("../assets/verbs/rennen.jpg"),
      title: "RENNEN",
    },
    {
      image: require("../assets/verbs/singen.jpg"),
      title: "SINGEN",
    },
    {
      image: require("../assets/verbs/schlafen.jpeg"),
      title: "SCHLAFEN",
    },
    {
      image: require("../assets/verbs/schwimmen.jpg"),
      title: "SCHWIMMEN",
    },
    {
      image: require("../assets/verbs/gehen.png"),
      title: "GEHEN",
    },
    {
      image: require("../assets/verbs/schreiben.jpg"),
      title: "SCHREIBEN",
    },
    {
      image: require("../assets/verbs/reinigen.png"),
      title: "REINIGEN",
    },
    {
      image: require("../assets/verbs/malen.jpeg"),
      title: "MALEN",
    },
    {
      image: require("../assets/verbs/waschen.jpeg"),
      title: "WASCHEN",
    },
    {
      image: require("../assets/verbs/lesen.png"),
      title: "LESEN",
    },
    {
      image: require("../assets/verbs/anrufen.jpeg"),
      title: "ANRUFEN",
    },
    {
      image: require("../assets/verbs/arbeiten.jpg"),
      title: "ARBEITEN",
    },
    {
      image: require("../assets/verbs/sprechen.png"),
      title: "SPRECHEN",
    },
    {
      image: require("../assets/verbs/denken.jpg"),
      title: "DENKEN",
    },
    {
      image: require("../assets/verbs/schneiden.jpg"),
      title: "SCHNEIDEN",
    },
    {
      image: require("../assets/verbs/tanzen.webp"),
      title: "TANZEN",
    },
    {
