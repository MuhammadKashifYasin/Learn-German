...
export const Vocabulary = ({ goBack, backgroundColor, title }) => {
  ...
  const data = [
    {
      name: require("../assets/petsImages/katze.jpeg"),
      title: "KATZE",
    },
    {
      name: require("../assets/petsImages/hund.jpeg"),
      title: "HUND",
    },
    {
      name: require("../assets/petsImages/vogel.jpeg"),
      title: "VOGEL",
    },
    {
      name: require("../assets/petsImages/fisch.jpeg"),
      title: "FISCH",
    },
    {
      name: require("../assets/petsImages/maus.jpeg"),
      title: "MAUS",
    },
    {
      name: require("../assets/petsImages/schildkrote.jpeg"),
      title: "SCHILDKRÖTE",
    },
    {
      name: require("../assets/petsImages/hase.jpeg"),
      title: "HASE",
    },
    {
      name: require("../assets/petsImages/chamaleon.jpeg"),
      title: "CHAMÄLEON",
    },
    {
      name: require("../assets/petsImages/papagei.jpeg"),
      title: "PAPAGEI",
    },
  ];
  ...
  return (
    <View style={{ flex: 1, marginBottom: hp(16) }}>
      ...
      completedVocabularies?.screenName === "pets" ? (
        <View>
...
export const Reading = ({ goBack, backgroundColor, title }) => {
  ...
  const options = [
    {
      image: require("../assets/petsImages/katze.jpeg"),
      title: "KATZE",
    },
    {
      image: require("../assets/petsImages/hund.jpeg"),
      title: "HUND",
    },
    {
      image: require("../assets/petsImages/vogel.jpeg"),
      title: "VOGEL",
    },
    {
      image: require("../assets/petsImages/fisch.jpeg"),
      title: "FISCH",
    },
    {
      image: require("../assets/petsImages/maus.jpeg"),
      title: "MAUS",
    },
    {
      image: require("../assets/petsImages/schildkrote.jpeg"),
      title: "SCHILDKRÖTE",
    },
    {
      image: require("../assets/petsImages/hase.jpeg"),
      title: "HASE",
    },
    {
      image: require("../assets/petsImages/chamaleon.jpeg"),
      title: "CHAMÄLEON",
    },
    {
      image: require("../assets/petsImages/papagei.jpeg"),
      title: "PAPAGEI",
    },
  ];
